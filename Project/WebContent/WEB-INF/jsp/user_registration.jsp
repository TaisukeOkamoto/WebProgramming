...
<body>
  ...
  <p class="errMsg">${dateTypeErrMessage}${inputEmptyMassage}${passwordOccupiedMassage}${duplicatedLoginIdMessage}</p>
  <div class="container">
  <form class="loginform form" action="UserRegistrationServlet" method="post">
    <div class="form_info_wrap">
      <dl>
        <dt>ログインID</dt><dd><input name="id" type="text" value="${loginId}"></dd>
        <dt>パスワード</dt><dd><input name="password" type="password"></dd>
        <dt>パスワード（確認）</dt><dd><input name="passwordConfirm" type="password"></dd>
        <dt>ユーザー名</dt><dd><input name="name" type="text" value="${name}"></dd>
        <dt>生年月日</dt><dd><input name="birthDate" type="text" placeholder="yyyy/mm/dd" value="<fmt:formatDate value='${birthDate}' pattern='yyyy/MM/dd'/>"></dd>
      </dl>
